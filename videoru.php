			...
			<section class="wrapper style1" id="Two" >
				<div class="inner" >
					...
					<form method="post" >							
							...
							<button type="submit" class="button alt"><span><b>Выбирать</b></span></button>
					</form>
						...
						LIMIT 9 OFFSET 1";
							...
							?>				
											<div class="video col">
												...
												<?php echo "<a href='videoru.php?videoid=".$row2['videoid']."' class='link'><span>Click Me</span></a>"; 
												?>
						...
						ORDER BY videotime DESC";
							...
							?>				
											<div class="video col">
												...
												<?php echo "<a href='videoru.php?videoid=".$row3['videoid']."' class='link'><span>Click Me</span></a>"; 
												 ?>
