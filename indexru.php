				...
				<section id="banner" data-video="images/banner">
					<div class="inner">
						<header>
							...
							<p>
							От Иоанна 3:16. Ибо так возлюбил Бог мир, что отдал Сына Своего Единородного,<br>
							дабы всякий верующий в Него, не погиб, но имел жизнь вечную.</p>
						</header>
		...
		<!-- Main -->
						...
						<!-- 2 Column Video Section -->
							...
							?>				
											<div class="video col">
												...
												echo "<a href='videoru.php?videoid=".$row['videoid']."' class='link'><span>Click Me</span></a>"; 
												}												
												?>
							...
							<header class="align-center">
							<?php echo "<a href='videostream.php' class='button big alt scrolly'><span>Прямая трансляция</span></a>"; ?>
							</header>
					</div>
				</section>
			...
			<!-- Two -->
				...
				<section class="wrapper style1">
					...
					echo "<a href='post.php' class='button big alt scrolly'><span>Новости</span></a>";	
					}
					 ?>
					</header>
					</div>
					...
					<div class="inner">
						...
						<section id="galleries">
							...
							<!-- Photo Galleries -->
								...
								echo "<a href='galleries.php' class='button big alt scrolly'><span>Фото галерея</span></a>";	
								}
								?>
								</header>
